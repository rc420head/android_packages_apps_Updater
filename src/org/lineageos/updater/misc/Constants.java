...
public final class Constants {
    ...
    public static final String PROP_DEVICE = "ro.devilian.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.devilian.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "devilian.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "devilian.updater.uri";
    public static final String PROP_VERSION = "ro.devilian.version";
